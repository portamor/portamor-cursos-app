      ...
      <div className={styles["footer-container"]}>
        ...
        <div>
          ...
          <div className={styles["whatsapp"]}>
            <a href="https://wa.me/51943203772?text=Bienvenid@%20a%20Portamor%20<3" target="_blank" title="Conversemos por Whatsapp">
              <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="whatsapp"
                   className="svg-inline--fa fa-whatsapp fa-w-14" role="img" xmlns="http://www.w3.org/2000/svg"
                   viewBox="0 0 448 512">
